...
const frameFunctions = [
  // ["SimpleSpringFrame", SpringFrame],
  ["NaturalSpringInFrame", UseNaturalParameters(SpringFrame)], 
  ["NaturalSpringOutFrame", EaseOut(UseNaturalParameters(SpringFrame))], 
  ["NaturalSpringInOutFrame", EaseInOut(UseNaturalParameters(SpringFrame))], 
  ["NaturalSpringOutInFrame", EaseOutIn(UseNaturalParameters(SpringFrame))]
] as const;
