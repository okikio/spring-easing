...
`,
            ...
            t.Vector = function(e) {
                ...
                t.Vector.prototype.upsert = function(e, r, n) {
                    ...
                    this.elements[i] == e ? this.elements[i + 1] = n(this.elements[i + 1], r)
                ...
                t.Vector.prototype.toArray = function() {
                    for (
                        var e = new Array(this.elements.length / 2), r = 1, n = 0; r < this.elements.length; r += 2, n++
                    ) {
                        e[n] = this.elements[r];
                    }
                    return e;
            ...
            t.TokenSet = function() {
                ...
                t.TokenSet.fromClause = function(e) {
                    return "editDistance" in e ? t.TokenSet.fromFuzzyString(e.term, e.editDistance)
                ...
                t.TokenSet.Builder.prototype.minimize = function(e) {
                    for (var r = this.uncheckedNodes.length - 1; r >= e; r--) {
                        ...
                        i in this.minimizedNodes
                            ...
                            : (n.child._str = i, this.minimizedNodes[i] = n.child), this.uncheckedNodes.pop();
                    }
                };
            t.Index = function(e) {
            ...
            t.Builder = function() {
                ...
                function(e, r) {
                    ...
                    : typeof ce == "object" ? he.exports = r() : e.lunr = r();
                }(this, function() {
                    return t;
                });
        })();
    ...
    function me(t, e) {
        ...
        if (!r) r = t.querySelector(e == 1 ? "li:first-child" : "li:last-child"), r && r.classList.add("current");
            ...
            let n = r;
            if (e === 1) do n = n.nextElementSibling; while (n instanceof HTMLElement && n.offsetParent == null);
            else do n = n.previousElementSibling; while (n instanceof HTMLElement && n.offsetParent == null);
    ...
    var ge = class {
        ...
        ne = class extends Q {
            constructor(e) {
                ...
                this.index = -1;
                this.createGroups(),
                    this.container && (this.el.classList.add("active"),
            ...
            setIndex(e) {
                if (
                    e < 0 && (e = 0), e > this.groups.length - 1 && (e = this.groups.length - 1), this.index == e
                ) {
                    return;
                }
                let r = this.groups[e];
